    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        <button
          ...
          className="bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-2xl p-6 text-left transition-colors"
        >
          <span className="text-4xl mb-3 block">📜</span>
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6">
        <h2 className="text-white font-bold text-lg mb-4">Recent Questions</h2>
        {isLoading ? (

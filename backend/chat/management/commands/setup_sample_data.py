# backend/chat/management/commands/setup_sample_data.py

from django.core.management.base import BaseCommand
from django.db import connection

class Command(BaseCommand):
    help = 'Create sample tables (products, customers, orders) in PostgreSQL'
    ...
    def handle(self, *args, **options):
        ...
        # Products table
        self.stdout.write("📦 Creating products table...")
        cursor.execute("""
        ...
        self.stdout.write(f"   ✅ Inserted {len(products_data)} products")
        
        # Customers table
        self.stdout.write("👥 Creating customers table...")
        cursor.execute("""
        ...
        self.stdout.write(f"   ✅ Inserted {len(customers_data)} customers")
        ...
        self.stdout.write(f"   ✅ Inserted {len(orders_data)} orders")
        
        self.stdout.write(self.style.SUCCESS('\n🎉 Sample database created successfully!'))
        self.stdout.write(self.style.SUCCESS('   Tables: products (10 rows), customers (7 rows), orders (12 rows)'))